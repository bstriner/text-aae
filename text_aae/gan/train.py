...
def generator_train_op(params, scope, loss):
    ...
    optimizer = tf.train.AdamOptimizer(learning_rate=params.gen_lr, name='GeneratorOpt')
...
def discriminator_train_op(params, scope, loss):
    ...
    optimizer = tf.train.AdamOptimizer(learning_rate=params.dis_lr, name='DiscriminatorOpt')
